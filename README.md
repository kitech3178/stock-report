...
매주 월~금 저녁 8시(한국시간)에 그날 장 마감 기준 리포트를 boribab73@gmail.com(받는 사람)과 숨은 참조 주소들로 보냅니다.
...
- 주말과 한국 공휴일(임시 휴장 포함)에는 리포트가 오지 않습니다. 예약 실행 시 네이버의 마지막 거래일이 오늘과 다르면 건너뜁니다. Actions 탭에서 수동 실행하면 휴일에도 마지막 거래일 기준으로 보냅니다.
- 저녁 8시 실행이라 외국인·기관 순매매도 그날 확정치가 반영됩니다.
